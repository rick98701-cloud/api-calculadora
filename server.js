...
app.post('/calcular-lucro', (req, res) => {
    // 1. Limpa e converte os valores recebidos do banco de dados do bot
    ...
    // 2. SÓ SOMA SE FOR UM REGISTRO REAL (Se for 'leitura', pula direto para o cálculo do relatório)
    ...
    // 3. Processa a matemática global com os dados acumulados reais
    ...
    // Função de formatação para pontos de milhar padrão BR
    const formatarBR = (num) => {
        return Number(num).toLocaleString('pt-BR', { minimumFractionDigits: 2, maximumFractionDigits: 2 });
    };

    // 4. Retorna as respostas limpas
    res.json({
...
app.listen(3000, () => console.log('API Ollympyus Completa e Operacional!'));
